...
const Favorites = () => {
    ...
    const fetchFavorites = async () => {
        try {
            ...
            const res = await fetch('https://ames-appetites-backend.vercel.app/api/favorites', {
                headers: {
    ...
    const handleRemoveFavorite = async (restaurantId) => {
        ...
        try {
            const token = localStorage.getItem('token');
            const res = await fetch(`https://ames-appetites-backend.vercel.app/api/favorites/${restaurantId}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`
                }
