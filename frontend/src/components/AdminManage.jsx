...
const AdminManagement = () => {
  ...
  async function loadRecentReviews() {
    try {
      ...
      const res = await fetch(
        "https://ames-appetites-backend.vercel.app/api/admin/recent-reviews",
        {
          headers: {
  ...
  async function handleLoadRestaurantForEdit(id) {
    try {
      ...
      const res = await fetch(`https://ames-appetites-backend.vercel.app/api/restaurants/${id}`);
      const data = await res.json();
  ...
  async function handleUpdateRestaurant(e) {
    ...
    try {
      ...
      const token = localStorage.getItem("token");
      const res = await fetch(
        `https://ames-appetites-backend.vercel.app/api/restaurants/${selectedRestaurantId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  async function handleDeleteReview(id) {
    ...
    try {
      ...
      const res = await fetch(`https://ames-appetites-backend.vercel.app/api/reviews/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: token ? `Bearer ${token}` : "",
