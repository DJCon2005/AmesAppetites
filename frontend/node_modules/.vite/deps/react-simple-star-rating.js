...
//#region node_modules/react-simple-star-rating/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: !0 });
	var e = require_jsx_runtime(), t = require_react(), o = function() {
	...
	function i(t) {
		...
		}, { children: e.jsx("path", { d: "M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" }) }));
	}
	function r(e, t) {
		switch (t.type) {
			case "PointerMove": return o(o({}, e), {
				hoverValue: t.payload,
				hoverIndex: t.index
			});
			case "PointerLeave": return o(o({}, e), {
				ratingValue: e.ratingValue,
				hoverIndex: 0,
				hoverValue: null
			});
			case "MouseClick": return o(o({}, e), {
	...
	(function(e, t) {
		...
		var je = t.useMemo((function() {
			...
			w,
			je
		]), Ae = t.useMemo((function() {
			return (P ? 2 * _ - 1 : _ - 1) || 0;
		}), [P, _]), Le = t.useCallback((function(e) {
		...
		var ze = t.useCallback((function(e) {
		...
		return e.jsxs("span", o({
			...
			var r;
			return e.jsx(t.Fragment, { children: (null === (r = N[n]) || void 0 === r ? void 0 : r.icon) || Q || e.jsx(i, {
				SVGclassName: ye,
				SVGstyle: xe,
				SVGstorkeWidth: Ce,
				SVGstrokeColor: Ve,
			...
			var r;
			return e.jsx(t.Fragment, { children: (null === (r = N[n]) || void 0 === r ? void 0 : r.icon) || O || e.jsx(i, {
				SVGclassName: ye,
				SVGstyle: xe,
				SVGstorkeWidth: Ce,
				SVGstrokeColor: Ve,
